function j = xy_axis_mpc(K, dt, p_0, v_0, a_0, pt, vt, at)
    ...
    vmin = 6.0; % Minimum velocity constraint
    amax = 3.0; % Maximum acceleration constraint
    amin = 3.0; % Minimum acceleration constraint
    jerkmax = 3.0; % Maximum jerk constraint
    jerkmin = 3.0; % Minimum jerk constraint
    ...
    w2 = 1.0; % Weight for velocity 
    w3 = 1.0; % Weight for acceleration 
    w4 = 1.0; % Weight for jerk 
